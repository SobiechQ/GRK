...
function mouseDragged(){
    ...
    // const vecPrim = multiplyMatrixVector(scalingMatrix(2,2), vec);
    // const vecPrim = multiplyMatrixVector(translationMatrix(100,100), vec);
    // const vecPrim = multiplyMatrixVector(rotationMatrix(-45), vec);
    const vecPrim = multiplyMatrixVector(shearMatrix(0.5,0.5), vec);
